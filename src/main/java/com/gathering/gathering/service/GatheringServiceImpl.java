...
public class GatheringServiceImpl implements GatheringService {
    ...
    public void readBookCompleted(String username, Long gatheringId) {
        ...
        UserAttendanceDomain userAttendance =
                userAttendanceRepository.findByUserIdAndCreateDateWithAttendanceBooksAndGathering(user.getId(), today);
        ...
        if(isUserAttendanceBook) {
            ...
            userAttendanceBookRepository.save(UserAttendanceBookDomain.create(userAttendance, gathering.getBook(), gathering));
        }
